...
public:
    ...
    //
    // tDigitize -- When to start producing integrated charge in time slices.
    //              This argument must be non-negative.
    //
    // TS, lenTS -- Array (and its length) where the integrated charge will
    //              be placed on exit.
    //
    // This method returns the number of "good" charge time slices -- the
    // ones that were completely covered by the simulation interval.
    //
